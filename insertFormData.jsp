        ...
        <%	  
        	  try
			  {
				...
				switch(Integer.parseInt(request.getParameter("formId")))
				{
					...
					case 3:insert = "INSERT INTO menu VALUES("+request.getParameter("resID")+","+request.getParameter("iid")+",\'"+request.getParameter("iname")+"\',"+request.getParameter("iprice")+",\'"+request.getParameter("idesc")+"\',\'"+request.getParameter("iimg")+"\')";out.println(insert);break;
				}
